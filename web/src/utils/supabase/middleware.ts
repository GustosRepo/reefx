...
export async function updateSession(request: NextRequest) {
  ...
  const publicPaths = ['/', '/login', '/register', '/api/stripe/webhook', '/auth/callback', '/reset-password', '/forgot-password', '/pricing', '/learn', '/privacy', '/terms', '/support']
  const isPublicPath = publicPaths.includes(request.nextUrl.pathname) || request.nextUrl.pathname.startsWith('/auth/') || request.nextUrl.pathname.startsWith('/learn/')
