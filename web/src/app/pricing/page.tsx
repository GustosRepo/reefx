...
export default function PricingPage() {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 z-50 w-full border-b backdrop-blur bg-black/70 border-white/10">
        <div className="flex items-center justify-between max-w-6xl px-4 sm:px-6 py-4 mx-auto">
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm font-medium text-gray-300">
            <Link href="/#pricing" className="transition hover:text-white">Overview</Link>
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col px-4 py-4 space-y-3 text-sm font-medium text-gray-300">
                <Link href="/#pricing" onClick={() => setMobileMenuOpen(false)} className="py-2 transition hover:text-white">Overview</Link>
      ...
      <main className="min-h-screen pt-32 pb-24 text-white bg-black">
        <div className="max-w-6xl px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur flex flex-col"
            >
              ...
              <Link
                href="/register"
                className="block w-full py-3 text-center bg-white/10 border border-white/20 rounded-xl font-semibold hover:bg-white/20 transition"
              >
                Get Started Free
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl border-2 border-purple-500/50 bg-white/5 backdrop-blur relative flex flex-col"
            >
              ...
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold text-white mb-1">
                  ...
                  <span className="text-lg font-normal text-gray-400">/{billingCycle === "monthly" ? "mo" : "yr"}</span>
                </div>
                {billingCycle === "yearly" && (
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl border-2 border-pink-500/50 bg-white/5 backdrop-blur relative flex flex-col"
            >
              <div className="absolute top-4 right-4">
          ...
          >
            ...
            <p className="text-center text-gray-400 mb-8">Everything you get with each plan, organized by category</p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10 bg-white/5 sticky top-0">
                    ...
                    <th className="text-center py-4 px-6 font-medium text-gray-400 min-w-[100px]">
                      <div className="text-2xl mb-1">🐚</div>
                      Free
                    </th>
                    <th className="text-center py-4 px-6 font-medium text-purple-400 min-w-[100px]">
                      <div className="text-2xl mb-1">👑</div>
                      Premium
                    </th>
                    <th className="text-center py-4 px-6 font-medium text-pink-400 min-w-[100px]">
                      <div className="text-2xl mb-1">🚀</div>
                      Super Premium
                    </th>
                  </tr>
                ...
                <tbody>
                  {featureCategories.map((category) => (
                    <>
                      {/* Category Header */}
                      <tr key={category.name} className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10">
                        <td colSpan={4} className="py-3 px-6 font-bold text-cyan-400 text-sm uppercase tracking-wide">
                          {category.name}
                        </td>
                      </tr>
                      ...
                      {category.features.map((feature, index) => (
                        <tr 
                          key={feature.name} 
                          className={`border-b border-white/5 ${index % 2 === 0 ? 'bg-white/[0.02]' : ''} hover:bg-white/5 transition`}
                        >
                          <td className="py-4 px-6">
                            <div className="font-medium text-white">{feature.name}</div>
                            <div className="text-xs text-gray-500 max-w-xs">{feature.description}</div>
                          </td>
          ...
          >
            ...
            <Link
              href="/register"
              className="inline-flex items-center gap-2 px-8 py-4 font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl hover:shadow-cyan-500/50 transition-all duration-300 shadow-lg"
            >
              🚀 Get Started Free
            </Link>
          </motion.div>
